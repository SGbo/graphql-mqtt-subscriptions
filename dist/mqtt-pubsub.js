...
var MQTTPubSub = (function () {
    function MQTTPubSub(options) {
        ...
        this.publishOptionsResolver = options.publishOptions || (function () { return Promise.resolve(clientSubscribeOptions); });
        this.subscribeOptionsResolver = options.subscribeOptions || (function () { return Promise.resolve(clientSubscribeOptions); });
